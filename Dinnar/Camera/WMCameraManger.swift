...
class WMCameraManger: NSObject {
    ...
    func setupCamera() {
        ...
        let centerRect = CGRect(x: showView.bounds.midX - 100, y: showView.bounds.midY - 100, width: 200, height: 200)
        let rectOfInterest = previewLayer.metadataOutputRectConverted(fromLayerRect: centerRect)
...
//        }
    ...
    func setupView() {
        focusImageView.image = UIImage.imageWithName(named: "sight_video_focus")
    ...
    func focusAt(_ point: CGPoint) {
        ...
        lockForConfiguration { [weak self] (devide) in
            ...
            if devide.isFocusPointOfInterestSupported {
                ...
                devide.videoZoomFactor = 2.2                
                NotificationCenter.default.post(name: NSNotification.Name("kFocreCameraPointKey"), object: nil)
            }
