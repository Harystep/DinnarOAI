...
//        output.rectOfInterest = CGRect(x: 0.2, y: 0.4, width: 0.4, height: 0.3)
        let x = ((screenHeight - 225 - statusHeight) / 2.0) / screenHeight
        let y = ((screenWidth - 225) / 2.0) / screenWidth
        let width = 225 / screenHeight
        let height = 225 / screenWidth
